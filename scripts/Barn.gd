...
func unload_eat(type, count):
	var bags ={
		"wheat":preload("res://scenes/Bug_Wheat.tscn"),
		"corn":preload("res://scenes/Bug_Corn.tscn"), 
		"compound_k3":preload("res://scenes/Bug_Compound_feed-k3.tscn"),
		"compound_k2":preload("res://scenes/Bug_Compound_feed-k2.tscn"),
		"compound_k1":preload("res://scenes/Bug_Compound_feed-k1.tscn")
		}
